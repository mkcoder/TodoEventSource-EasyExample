...
namespace TodoEventSource_EasyExample
{
    ...
    public class CreateNewTodoItem : Event
    {
        public Guid Guid { get; }
        public string ToDoName { get; }

        public CreateNewTodoItem(Guid guid, string toDoName)
        {
            Guid = guid;
            ToDoName = toDoName;
        }
    ...
    public class UpdateTodItemStatus : Event
    {
        public Guid Guid { get; }
        public bool Done { get; }

        public UpdateTodItemStatus(Guid guid, bool done)
        {
            Guid = guid;
            Done = done;
        }        
    ...
    public class DeleteToDoItem : Event
    {
        public Guid Guid { get; }
        public bool Delete { get; }

        public DeleteToDoItem(bool delete, Guid guid)
        {
            Delete = delete;
            Guid = guid;
        }
